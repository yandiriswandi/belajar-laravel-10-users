...
// Route::group(['prefix' => 'admin', 'middleware' => ['auth','can:view_dashboard','permission:view_dashboard','role:admin|writer'], 'as' => 'admin.'], function () {
// untuk permission jika ingin di taruh di group route
Route::group(['prefix' => 'admin', 'middleware' => ['auth'], 'as' => 'admin.'], function () {
    ...
    //jika ingin di taruh di middleware 
    //memakai laravel gate can('view_dashboard')
